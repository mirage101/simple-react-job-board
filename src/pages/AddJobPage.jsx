        ...
        <div className="px-6 py-8 m-4 mb-4 bg-white border rounded-md shadow-md md:m-0">
          <form onSubmit={submitForm}>
            ...
            <div className="mb-4">
              ...
              <select id="type" name="type" className="w-full px-3 py-2 border rounded" required value={type} onChange={(e) => setType(e.target.value)}>
            ...
            <div className="mb-4">
              ...
              <select id="salary" name="salary" className="w-full px-3 py-2 border rounded" required value={salary} onChange={(e) => setSalary(e.target.value)}>
            ...
            <div>
              <button className="w-full px-4 py-2 font-bold text-white bg-indigo-500 rounded-full hover:bg-indigo-600 focus:outline-none focus:shadow-outline" type="submit">
                Add Job
              </button>
            </div>
          </form>
