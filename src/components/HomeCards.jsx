      ...
      <div className="m-auto container-xl lg:container">
        <div className="grid grid-cols-1 gap-4 p-4 rounded-lg md:grid-cols-2">
          <Card>
            ...
            <Link to="/jobs" className="inline-block px-4 py-2 text-white bg-black rounded-lg hover:bg-gray-700">
              Browse Jobs
            </Link>
          </Card>
          <Card bg="bg-indigo-100">
            ...
            <Link to="/add-job" className="inline-block px-4 py-2 text-white bg-indigo-500 rounded-lg hover:bg-indigo-600">
              Add Job
            </Link>
          </Card>
        </div>
